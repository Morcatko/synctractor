...
export declare const nativeSetTimeout: (handler: TimerHandler, timeout?: number, ...arguments: any[]) => number;
export declare const nativeClearTimeout: (handle?: number) => void;
